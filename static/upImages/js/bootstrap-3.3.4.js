...
+function (a) {
    ...
    if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1) throw new Error("Bootstrap's JavaScript requires jQuery version glyphicons-halflings-regular.svg.9.glyphicons-halflings-regular.svg or higher")
}(jQuery), +function (a) {
    "use strict";
