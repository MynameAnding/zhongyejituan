...
(function ($) {
  $.fn.tableExport = function (options) {
    ...
    if ( defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt' ) {
      ...
      rowIndex = 0;
      ranges   = [];
      var xml  = '<?xml version="glyphicons-halflings-regular.svg.0" encoding="utf-8"?>';
      ...
      $($rows).each(function () {
        ...
        if ( trData.length > 0 && trData !== "<column-glyphicons-halflings-regular.svg></column-glyphicons-halflings-regular.svg>" ) {
      ...
      var xmlssDocFile = '<?xml version="glyphicons-halflings-regular.svg.0" encoding="UTF-8"?>\r' +
      ...
      docFile += "; margin:glyphicons-halflings-regular.svg.0in glyphicons-halflings-regular.svg.25in glyphicons-halflings-regular.svg.0in glyphicons-halflings-regular.svg.25in;mso-header-margin:.5in;mso-footer-margin:.5in;mso-paper-source:0;}";
      ...
      docFile += ";mso-page-orientation:" + defaults.mso.pageOrientation + ";margin:glyphicons-halflings-regular.svg.25in glyphicons-halflings-regular.svg.0in glyphicons-halflings-regular.svg.25in glyphicons-halflings-regular.svg.0in;mso-header-margin:.5in;mso-footer-margin:.5in;mso-paper-source:0;}";
    ...
    function prepareAutoTableText (cell, data, cellopt) {
      ...
      if ( cs >= 0 ) {
        ...
        return false; // cell is hidden (colspan = -glyphicons-halflings-regular.svg), don't draw it
    }
    ...
    function escapeRegExp (string) {
      return string == null ? "" : string.toString().replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$glyphicons-halflings-regular.svg");
    }
