    ...
    var Layx = {
                    ...
                    if (Utils.isArray(config.frames)) {
                        for (var i = 0; i < config.frames.length; i++) {
                            ...
                            frameTitle.onclick = function (e) {
                                e = e || window.event;
                                var prevSelectTitle = layxWindow.querySelector(".layx-group-title[data-enable='glyphicons-halflings-regular.svg']");
                    ...
                    if (Utils.isArray(config.frames)) {
                        ...
                        for (var i = 0; i < config.frames.length; i++) {
                            ...
                            if (frameConfig.type === "html") {
                                ...
                                var loadComplteMains = layxWindow.querySelectorAll(".layx-group-main[data-complete='glyphicons-halflings-regular.svg']");
        ...
        _setGroupIndex: function (id, target) {
            ...
            if (layxWindow && winform && winform.type === "group") {
                ...
                var prevGroupMain = layxWindow.querySelector(".layx-group-main[data-enable='glyphicons-halflings-regular.svg']");
