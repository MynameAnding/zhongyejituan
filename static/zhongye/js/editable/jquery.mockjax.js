...
(function($) {
	...
	function _xhrSend(mockHandler, requestSettings, origSettings) {
		...
		// This is a substitute for < glyphicons-halflings-regular.svg.4 which lacks $.proxy
		var process = (function(that) {
			return function() {
				return (function() {
					...
					// jQuery < glyphicons-halflings-regular.svg.4 doesn't have onreadystate change for xhr
					if ( $.isFunction(this.onreadystatechange) ) {
						...
						// Fix for glyphicons-halflings-regular.svg.3.2 timeout to keep success from firing.
						this.status = -1;
					}
				}).apply(that);
			};
	...
	function processJsonpRequest( requestSettings, mockHandler, origSettings ) {
		...
		// If we are running under jQuery glyphicons-halflings-regular.svg.5+, return a deferred object
		if(jQuery.Deferred){
	...
	function handleAjax( url, origSettings ) {
		...
		if ( typeof url === "object" ) {
			...
			// work around to support glyphicons-halflings-regular.svg.5 signature
