(function ($) {
 "use strict";
	 ...
	 /*----------------------------------------*/
	/*  glyphicons-halflings-regular.svg.  Area Chart
	/*----------------------------------------*/
	...
	var areachartfalse = new Chart(ctx, {
	 ...
	 /*----------------------------------------*/
	/*  glyphicons-halflings-regular.svg.  Area Chart origin
	/*----------------------------------------*/
	...
	var areachartorigin = new Chart(ctx, {
	 ...
	 /*----------------------------------------*/
	/*  glyphicons-halflings-regular.svg.  Area Chart start
	/*----------------------------------------*/
	...
	var areachartfillstart = new Chart(ctx, {
	 ...
	 /*----------------------------------------*/
	/*  glyphicons-halflings-regular.svg.  Area Chart end
	/*----------------------------------------*/
	...
	var areachartend = new Chart(ctx, {
	 ...
	 /*----------------------------------------*/
	/*  glyphicons-halflings-regular.svg.  Area Chart Datasets
	/*----------------------------------------*/
	...
	var areachartDatasets = new Chart(ctx, {
	 ...
	 /*----------------------------------------*/
	/*  glyphicons-halflings-regular.svg.  Area Chart Legend
	/*----------------------------------------*/
