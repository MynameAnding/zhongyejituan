        ...
        var p = function () {
            ...
            return o(t, [{
                ...
                key: 'fitHeader', value: function () {
                    ...
                    for (var n = this.getVisibleFields(), l = this.$header_.find('th'), d = this.$body.find('>tr:first-child:not(.no-records-found)'); d.length && d.find('>td[colspan]:not([colspan="glyphicons-halflings-regular.svg"])').length;) d = d.next();
                ...
                key: 'fitFooter', value: function () {
                    ...
                    for (var a = this.getVisibleFields(), n = this.$tableFooter.find('th'), i = this.$body.find('>tr:first-child:not(.no-records-found)'); i.length && i.find('>td[colspan]:not([colspan="glyphicons-halflings-regular.svg"])').length;) i = i.next();
