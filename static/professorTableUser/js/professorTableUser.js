var dict = {
    ...
    "zhiwu": "面积mm²",
    "zhicheng": "屈服负荷kN Fp0.2",
    "shenfenzhenghao": "屈服强度 MPa Rp0.2",
    ...
    columns: [
        ...
        },
        {
            ...
            formatter:function(value,row,index){
                return '<div style="overflow: auto;width:100%;max-height: 5em"> <p style="font-size: small">'+value+'</p></div>';
            }
        },
        {
            field: 'name',
        ...
        },
        {
            ...
            maxHeight:'5em',
            formatter:function(value,row,index){
                return '<div style="overflow: auto;width:100%;max-width:15em;min-width:8em;max-height: 5em"> <p style="font-size: small">'+value+'</p></div>';
            }
        },
        {
        ...
        {
            field: 'zhicheng',
            title: '屈服强度 MPa Rp0.2',
            maxHeight:'5em',
            align: 'center',
            valign:'center',
            formatter:function(value,row,index){
                return '<div style="overflow: auto;width:100%;min-width:3em;max-height: 5em"> <p style="font-size: small">'+value+'</p></div>';
            }
        },
        {
        ...
        },
        {
            ...
            valign:'center',
            formatter:function(value,row,index){
                return '<div style="overflow: auto;max-width:5em;max-height: 5em"> <p style="font-size: small">'+value+'</p></div>';
            }
        },
        {
            field: 'shehuijianzhi',
            ...
            valign:'center',
            formatter:function(value,row,index){
                return '<div style="overflow: auto;max-width:7em;min-width:4em;max-height: 5em"> <p style="font-size: small">'+value+'</p></div>';
            }
        ...
        },
        {
            ...
            formatter:function(value,row,index){
                ...
                var labelsList = value.toString().split(",");
                var html = '';
                for(var index = 0;index<labelsList.length;index++){
                    html +=  labelsList[index]+'<br>';
                }
                return '<div style="overflow: auto;width:100%;min-width:4em;max-height: 5em"> <p style="font-size: small">'+html+'</p></div>';
            }
