(function (global, factory) {
     ...
     * version: glyphicons-halflings-regular.svg.14.2
    ...
    (function ($) {
        ...
        try {
            ...
            // It is undefined in older versions of Bootstrap (tested with 3.glyphicons-halflings-regular.svg.glyphicons-halflings-regular.svg).
        ...
        var BootstrapTable = function () {
            ...
            _createClass(BootstrapTable, [{
                ...
                value: function initContainer() {
                    ...
                    this.$container = $('         <div class="bootstrap-table">         <div class="fixed-table-toolbar"></div>         ' + topPagination + '         <div class="fixed-table-container">         <div class="fixed-table-header"><table></table></div>         <div class="fixed-table-body">         <div class="fixed-table-loading">         <span class="loading-wrap">         <span class="loading-text">' + this.options.formatLoadingMessage() + '</span>         <span class="animation-wrap"><span class="animation-dot"></span></span>         </span>         </div>         </div>         <div class="fixed-table-footer"><table><thead><tr></tr></thead></table></div>         </div>         ' + bottomPagination + '         </div>       ');
                ...
                value: function initHeader() {
                    ...
                    this.options.columns.forEach(function (columns, i) {
                        ...
                        if (i === 0 && !_this2.options.cardView && _this2.options.detailView) {
                            html.push('<th class="detail" rowspan="' + _this2.options.columns.length + '">             <div class="fht-cell"></div>             </th>           ');
                        }
                ...
                value: function initToolbar() {
                    ...
                    if (o.showPaginationSwitch) {
                        html.push('<button class="' + this.constants.buttonsClass + '" type="button" name="paginationSwitch"           aria-label="Pagination Switch" title="' + o.formatPaginationSwitch() + '">           ' + Utils.sprintf(this.constants.html.icon, o.iconsPrefix, o.icons.paginationSwitchDown) + '           </button>');
                    }

                    if (o.showRefresh) {
                        html.push('<button class="' + this.constants.buttonsClass + '" type="button" name="refresh"           aria-label="Refresh" title="' + o.formatRefresh() + '">           ' + Utils.sprintf(this.constants.html.icon, o.iconsPrefix, o.icons.refresh) + '           </button>');
                    }

                    if (o.showToggle) {
                        html.push('<button class="' + this.constants.buttonsClass + '" type="button" name="toggle"           aria-label="Toggle" title="' + o.formatToggle() + '">           ' + Utils.sprintf(this.constants.html.icon, o.iconsPrefix, o.icons.toggleOff) + '           </button>');
                    }

                    if (o.showFullscreen) {
                        html.push('<button class="' + this.constants.buttonsClass + '" type="button" name="fullscreen"           aria-label="Fullscreen" title="' + o.formatFullscreen() + '">           ' + Utils.sprintf(this.constants.html.icon, o.iconsPrefix, o.icons.fullscreen) + '           </button>');
                    }

                    if (o.showColumns) {
                        html.push('<div class="keep-open ' + this.constants.classes.buttonsDropdown + '" title="' + o.formatColumns() + '">           <button class="' + this.constants.buttonsClass + ' dropdown-toggle" type="button" data-toggle="dropdown"           aria-label="Columns" title="' + o.formatColumns() + '">           ' + Utils.sprintf(this.constants.html.icon, o.iconsPrefix, o.icons.columns) + '           ' + this.constants.html.dropdownCaret + '           </button>           ' + this.constants.html.toobarDropdow[0]);
                    ...
                    if (o.search) {
                        html = [];
                        html.push('<div class="' + this.constants.classes.pull + '-' + o.searchAlign + ' search ' + this.constants.classes.inputGroup + '">           <input class="' + this.constants.classes.input + Utils.sprintf(' input-%s', o.iconSize) + '"           type="text" placeholder="' + o.formatSearch() + '">           </div>');
                ...
                value: function initPagination() {
                    ...
                    html.push('<div class="' + this.constants.classes.pull + '-' + o.paginationDetailHAlign + ' pagination-detail"><span class="pagination-info">' + ' ' + '</span>');

                    if (!o.onlyInfoPagination) {
                        html.push('<span class="page-list">');

                        var pageNumber = ['<span class="' + this.constants.classes.paginationDropdown + '">           <button class="' + this.constants.buttonsClass + ' dropdown-toggle" type="button" data-toggle="dropdown">           <span class="page-size">           ' + ($allSelected ? o.formatAllRows() : o.pageSize) + '           </span>           ' + this.constants.html.dropdownCaret + '           </button>           ' + this.constants.html.pageDropdown[0]];
                ...
                value: function initRow(item, i, data, parentDom) {
                    ...
                    if (!this.options.cardView && this.options.detailView) {
                        ...
                        if (Utils.calculateObjectValue(null, this.options.detailFilter, [i, item])) {
                            html.push('             <a class="detail-icon" href="#">             ' + Utils.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen) + '             </a>           ');
                        }
                    ...
                    this.header.fields.forEach(function (field, j) {
                        ...
                        if (column.checkbox || column.radio) {
                            ...
                            text = [_this7.options.cardView ? '<div class="card-view ' + c + '">' : '<td class="bs-checkbox ' + c + '">', '<label>               <input               data-index="' + i + '"               name="' + _this7.options.selectItemName + '"               type="' + type + '"               ' + Utils.sprintf('value="%s"', item[_this7.options.idField]) + '               ' + Utils.sprintf('checked="%s"', isChecked ? 'checked' : undefined) + '               ' + Utils.sprintf('disabled="%s"', isDisabled ? 'disabled' : undefined) + ' />               <span></span>               </label>', _this7.header.formatters[j] && typeof value === 'string' ? value : '', _this7.options.cardView ? '</div>' : '</td>'].join('');
                ...
                value: function fitHeader() {
                    ...
                    while ($tr.length && $tr.find('>td[colspan]:not([colspan="glyphicons-halflings-regular.svg"])').length) {
                        $tr = $tr.next();
                    }
