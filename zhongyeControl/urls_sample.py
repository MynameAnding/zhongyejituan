...
urlpatterns = [
    ...
    url(r'sample_index/updateExperiment/$', sample.updateSample, name="updateExperiment"),
    url(r'sample_index/loadExperimentData/$', sample.loadSampleData, name="loadExperimentData"),
